...
def chat():
    ...
    def conversational_chat(query):
        ...
        memory = ConversationBufferMemory(memory_key="chat_history", input_key='question', output_key='answer', return_messages=True )#memory_key="chat_history", return_messages=True)
